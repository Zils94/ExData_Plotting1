...
plot(hs$DayTime,hs$Global_active_power,xlab="",ylab="Global Active Power",type='lines')

plot(hs$DayTime,hs$Voltage,type="lines",xlab="datetime",ylab="Voltage")
...
plot(hs$DayTime,hs$Global_reactive_power,type="lines",xlab="datetime",ylab="Global_reactive_power")
